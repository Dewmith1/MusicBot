...
async def song(client, message):
 #ImJanindu #JEBotZ
    ...
    time.time()
    if song:
        await rkp.edit("Uploading...") #IMkashyapaa 
        lol = "./thumb.jpg"
...
async def song(client, message):
    ...
    time.time()
    if song:
        await rkp.edit("🎵Uploading... @Imkashyapaa") #IMkashyapaa
        lol = "./thumb.jpg"
        lel = await message.reply_audio(
                 f"{rip_data['id']}.mp3",
                 duration=int(rip_data["duration"]),
...
async def start(client, message):
   if message.chat.type == 'private':
       await Jebot.send_message(
               ...
               text="""<b>https://telegra.ph/file/73422b014dca50b1023e6.jpg
               👋🏻Hey There, I'm a Song Downloader Bot. A bot Maded by @Imkashyapaa 👻.
...
@Imkashyapaa.on_message(filters.command("help"))
